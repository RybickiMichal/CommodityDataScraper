...
import pl.investadvisor.datascraper.ExampleCommodities;
...
public class PriceScrapeService {
    ...
    public void scrapePrices() {
        //TODO replace it by data from db
        List<Commodity> commodities = ExampleCommodities.exampleCommodities();
    ...
    private List<CommodityPrice> scrapePricesFromFinage(List<Commodity> commodities) {
        ...
        for (Commodity commodity : commodities) {
            log.info("starting scrape " + commodity);
